...
# export NCCL_IB_HCA=mlx5_0,mlx5_1,mlx5_4,mlx5_5,mlx5_8,mlx5_9,mlx5_10
# export NCCL_SOCKET_IFNAME=bond0.1417
...
# # take wandb offline when no internet
...
--seed=7 \
--exp=pre \
--timestamp=2605160748 \
--train.name=pretrain \
--train.data_parallel=deepspeed \
--train.deepspeed_config=${DEEPSPEED_CONFIG:-scripts/deepspeed/zero3.json} \
...
--data.root-dir=/mnt/beegfs/datasets/egodex \

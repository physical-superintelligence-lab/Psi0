...
--log.report_to=wandb \
--data.root_dir=data \
--data.train_repo_ids=mobile_pick_place_0709_psix_train/g1 \
--data.val_repo_ids=mobile_pick_place_0709_psix_val/g1 \
...
--data.transform.field.stat-path=mobile_pick_place_0709_psix_train/g1/meta/stats_psi0.json \

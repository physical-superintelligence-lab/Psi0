...
--data.train_repo_ids=G1WholebodyXMoveBendCarryBoxSonic-v0 \
--data.val_repo_ids=G1WholebodyXMoveBendCarryBoxSonic-v0 \
...
--data.transform.field.stat-path=/hfm/data/simple/G1WholebodyXMoveBendCarryBoxSonic-v0/meta/stats_psi0.json \

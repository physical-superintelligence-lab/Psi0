...
--log.report_to=wandb \
--data.root_dir=data/g1_neck30fps_0622 \
--data.train_repo_ids=g1 \
...
--data.transform.repack.instruction-key=task_description \
--data.transform.field.stat-path=g1_neck30fps_0622/g1/meta/stats_psi0.json \
